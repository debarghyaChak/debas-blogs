...
export default async function Page({ params }) {
    try {
        ...
        // Date Handling with Error Handling
        ...
        return (
            <div className="max-w-6xl mx-auto p-4 prose dark:prose-invert">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <p className="text-sm text-gray-500 mb-4">{`on ${formattedDate}`}</p> {/* Correct usage */}
                </div>
                <div
        ...
        return (
            <div className="max-w-6xl mx-auto p-4">
                ...
                <p>Please check the file path or try again later.</p>
            </div>
        );
    }
}
